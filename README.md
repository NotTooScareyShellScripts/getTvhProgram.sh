...
```
curl -s 'http://user:pass@TVH_SERVER:9981/api/epg/events/grid?mode=now&channel=CBS13'|jq
{
  "totalCount": 1,
  "entries": [
    {
...
*Note jq is just assembling the defaults, the sort in this cae is serverside API
